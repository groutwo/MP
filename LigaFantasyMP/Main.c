...
static void showUserMenuConfigRoster( int rosterID );
    ...
    do{
        ...
        switch( op ){
            case 1:
                ...
                break;
            case 2:
                rosterID = chooseRoster( user.ID );
                showUserMenuConfigRoster( rosterID );
                break;
            case 3:
    ...
    do{
        ...
        switch( op ){
            ...
            case 2:
                ...
                break;
            case 3:
                addPlayerToRoster( user.ID, rosterID );
                break;
            case 4:
                deletePlayerFromRoster( rosterID );
                break;
            case 5:
                break;
            default:
